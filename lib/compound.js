...
function validatePattern(formula) {
    var validityMatrix = {
        S: { U: true,                   O: true,          I: true, E: true },
        U: { U: true, L: true, N: true, O: true, C: true, I: true, E: true },
        L: { U: true, L: true, N: true, O: true, C: true, I: true, E: true },
        N: { U: true,          N: true, O: true, C: true, I: true, E: true },
        O: { U: true,                   O: true,          I: true         },
        C: { U: true,          N: true, O: true, C: true, I: true, E: true },
        I: { U: true, L: true, N: true, O: true, C: true, I: true, E: true },
        E: {                                                               }
    };
